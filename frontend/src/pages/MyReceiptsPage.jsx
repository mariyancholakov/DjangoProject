      ...
      <div className="flex justify-between px-10 mb-12">
        ...
        <div className="flex gap-6">
          <select
            ...
            className="shadow-md bg-white/50 shadow-blue-600/30 focus:shadow-blue-500/50 placeholder:text-gray-600 outline-none rounded-full h-10 w-40 pl-4 cursor-pointer"
          >
